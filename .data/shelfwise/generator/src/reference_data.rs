...
pub fn init_brands_reference() -> Vec<Brand> {
    vec![
        ...
        // Additional brands for variety (64-80)
        Brand {
            brand_id: 64,
            brand_name: "Trader Joes".to_string(),
            brand_tier: "mid".to_string(),
            manufacturer: "Trader Joe's".to_string(),
            is_private_label: true,
            brand_popularity: 1.3,
        },
        Brand {
            brand_id: 65,
            brand_name: "365 Whole Foods".to_string(),
            brand_tier: "premium".to_string(),
            manufacturer: "Whole Foods Market".to_string(),
            is_private_label: true,
            brand_popularity: 1.0,
        },
        Brand {
            brand_id: 66,
            brand_name: "Kirkland".to_string(),
            brand_tier: "value".to_string(),
            manufacturer: "Costco".to_string(),
            is_private_label: true,
            brand_popularity: 1.4,
        },
        Brand {
            brand_id: 67,
            brand_name: "Great Value".to_string(),
            brand_tier: "value".to_string(),
            manufacturer: "Walmart".to_string(),
            is_private_label: true,
            brand_popularity: 1.5,
        },
        Brand {
            brand_id: 68,
            brand_name: "Simple Truth".to_string(),
            brand_tier: "mid".to_string(),
            manufacturer: "Kroger".to_string(),
            is_private_label: true,
            brand_popularity: 1.1,
        },
        Brand {
            brand_id: 69,
            brand_name: "Signature Select".to_string(),
            brand_tier: "mid".to_string(),
            manufacturer: "Albertsons".to_string(),
            is_private_label: true,
            brand_popularity: 1.0,
        },
        Brand {
            brand_id: 70,
            brand_name: "Applegate".to_string(),
            brand_tier: "premium".to_string(),
            manufacturer: "Hormel Foods Corp".to_string(),
            is_private_label: false,
            brand_popularity: 0.75,
        ...
        Brand {
            brand_id: 72,
            brand_name: "Stonyfield".to_string(),
            brand_tier: "premium".to_string(),
            manufacturer: "Danone SA".to_string(),
            is_private_label: false,
            brand_popularity: 0.8,
        ...
        Brand {
            brand_id: 74,
            brand_name: "So Delicious".to_string(),
            brand_tier: "premium".to_string(),
            manufacturer: "Danone SA".to_string(),
            is_private_label: false,
            brand_popularity: 0.7,
        ...
        Brand {
            ...
            brand_tier: "mid".to_string(),
            manufacturer: "Colgate-Palmolive".to_string(),
            is_private_label: false,
            brand_popularity: 1.15,
        },
        Brand {
            brand_id: 80,
            brand_name: "Seventh Generation".to_string(),
            brand_tier: "premium".to_string(),
            manufacturer: "Unilever PLC".to_string(),
            is_private_label: false,
            brand_popularity: 0.75,
