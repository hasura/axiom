...
COPY chassis FROM '/docker-entrypoint-initdb.d/f1db-chassis.csv' DELIMITER ',' CSV HEADER;

COPY circuits FROM '/docker-entrypoint-initdb.d/f1db-circuits.csv' DELIMITER ',' CSV HEADER;

COPY constructors_chronology FROM '/docker-entrypoint-initdb.d/f1db-constructors-chronology.csv' DELIMITER ',' CSV HEADER;

COPY constructors FROM '/docker-entrypoint-initdb.d/f1db-constructors.csv' DELIMITER ',' CSV HEADER;

COPY continents FROM '/docker-entrypoint-initdb.d/f1db-continents.csv' DELIMITER ',' CSV HEADER;

COPY countries FROM '/docker-entrypoint-initdb.d/f1db-countries.csv' DELIMITER ',' CSV HEADER;

COPY drivers_family_relationships FROM '/docker-entrypoint-initdb.d/f1db-drivers-family-relationships.csv' DELIMITER ',' CSV HEADER;

COPY drivers FROM '/docker-entrypoint-initdb.d/f1db-drivers.csv' DELIMITER ',' CSV HEADER;

COPY engine_manufacturers FROM '/docker-entrypoint-initdb.d/f1db-engine-manufacturers.csv' DELIMITER ',' CSV HEADER;

COPY engines FROM '/docker-entrypoint-initdb.d/f1db-engines.csv' DELIMITER ',' CSV HEADER;

COPY entrants FROM '/docker-entrypoint-initdb.d/f1db-entrants.csv' DELIMITER ',' CSV HEADER;

COPY grands_prix FROM '/docker-entrypoint-initdb.d/f1db-grands-prix.csv' DELIMITER ',' CSV HEADER;

COPY races_constructor_standings FROM '/docker-entrypoint-initdb.d/f1db-races-constructor-standings.csv' DELIMITER ',' CSV HEADER;

COPY races_driver_of_the_day_results FROM '/docker-entrypoint-initdb.d/f1db-races-driver-of-the-day-results.csv' DELIMITER ',' CSV HEADER;

COPY races_driver_standings FROM '/docker-entrypoint-initdb.d/f1db-races-driver-standings.csv' DELIMITER ',' CSV HEADER;

COPY races_fastest_laps FROM '/docker-entrypoint-initdb.d/f1db-races-fastest-laps.csv' DELIMITER ',' CSV HEADER;

COPY races_free_practice_1_results FROM '/docker-entrypoint-initdb.d/f1db-races-free-practice-1-results.csv' DELIMITER ',' CSV HEADER;

COPY races_free_practice_2_results FROM '/docker-entrypoint-initdb.d/f1db-races-free-practice-2-results.csv' DELIMITER ',' CSV HEADER;

COPY races_free_practice_3_results FROM '/docker-entrypoint-initdb.d/f1db-races-free-practice-3-results.csv' DELIMITER ',' CSV HEADER;

COPY races_free_practice_4_results FROM '/docker-entrypoint-initdb.d/f1db-races-free-practice-4-results.csv' DELIMITER ',' CSV HEADER;

COPY races_pit_stops FROM '/docker-entrypoint-initdb.d/f1db-races-pit-stops.csv' DELIMITER ',' CSV HEADER;

COPY races_pre_qualifying_results FROM '/docker-entrypoint-initdb.d/f1db-races-pre-qualifying-results.csv' DELIMITER ',' CSV HEADER;

COPY races_qualifying_1_results FROM '/docker-entrypoint-initdb.d/f1db-races-qualifying-1-results.csv' DELIMITER ',' CSV HEADER;

COPY races_qualifying_2_results FROM '/docker-entrypoint-initdb.d/f1db-races-qualifying-2-results.csv' DELIMITER ',' CSV HEADER;

COPY races_qualifying_results FROM '/docker-entrypoint-initdb.d/f1db-races-qualifying-results.csv' DELIMITER ',' CSV HEADER;

COPY races_race_results FROM '/docker-entrypoint-initdb.d/f1db-races-race-results.csv' DELIMITER ',' CSV HEADER;

COPY races_sprint_qualifying_results FROM '/docker-entrypoint-initdb.d/f1db-races-sprint-qualifying-results.csv' DELIMITER ',' CSV HEADER;

COPY races_sprint_race_results FROM '/docker-entrypoint-initdb.d/f1db-races-sprint-race-results.csv' DELIMITER ',' CSV HEADER;

COPY races_sprint_starting_grid_positions FROM '/docker-entrypoint-initdb.d/f1db-races-sprint-starting-grid-positions.csv' DELIMITER ',' CSV HEADER;

COPY races_starting_grid_positions FROM '/docker-entrypoint-initdb.d/f1db-races-starting-grid-positions.csv' DELIMITER ',' CSV HEADER;

COPY races_warming_up_results FROM '/docker-entrypoint-initdb.d/f1db-races-warming-up-results.csv' DELIMITER ',' CSV HEADER;

COPY races FROM '/docker-entrypoint-initdb.d/f1db-races.csv' DELIMITER ',' CSV HEADER;

COPY seasons_constructor_standings FROM '/docker-entrypoint-initdb.d/f1db-seasons-constructor-standings.csv' DELIMITER ',' CSV HEADER;

COPY seasons_constructors FROM '/docker-entrypoint-initdb.d/f1db-seasons-constructors.csv' DELIMITER ',' CSV HEADER;

COPY seasons_driver_standings FROM '/docker-entrypoint-initdb.d/f1db-seasons-driver-standings.csv' DELIMITER ',' CSV HEADER;

COPY seasons_drivers FROM '/docker-entrypoint-initdb.d/f1db-seasons-drivers.csv' DELIMITER ',' CSV HEADER;

COPY seasons_engine_manufacturers FROM '/docker-entrypoint-initdb.d/f1db-seasons-engine-manufacturers.csv' DELIMITER ',' CSV HEADER;

COPY seasons_entrants_chassis FROM '/docker-entrypoint-initdb.d/f1db-seasons-entrants-chassis.csv' DELIMITER ',' CSV HEADER;

COPY seasons_entrants_constructors FROM '/docker-entrypoint-initdb.d/f1db-seasons-entrants-constructors.csv' DELIMITER ',' CSV HEADER;

COPY seasons_entrants_drivers FROM '/docker-entrypoint-initdb.d/f1db-seasons-entrants-drivers.csv' DELIMITER ',' CSV HEADER;

COPY seasons_entrants_engines FROM '/docker-entrypoint-initdb.d/f1db-seasons-entrants-engines.csv' DELIMITER ',' CSV HEADER;

COPY seasons_entrants_tyre_manufacturers FROM '/docker-entrypoint-initdb.d/f1db-seasons-entrants-tyre-manufacturers.csv' DELIMITER ',' CSV HEADER;

COPY seasons_entrants FROM '/docker-entrypoint-initdb.d/f1db-seasons-entrants.csv' DELIMITER ',' CSV HEADER;

COPY seasons_tyre_manufacturers FROM '/docker-entrypoint-initdb.d/f1db-seasons-tyre-manufacturers.csv' DELIMITER ',' CSV HEADER;

COPY seasons FROM '/docker-entrypoint-initdb.d/f1db-seasons.csv' DELIMITER ',' CSV HEADER;

COPY tyre_manufacturers FROM '/docker-entrypoint-initdb.d/f1db-tyre-manufacturers.csv' DELIMITER ',' CSV HEADER;
